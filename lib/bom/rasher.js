...
export const ATTACH = 'addEventListener' in window ? SUPPORTS_ADD : 'attachEvent' in window ? SUPPORTS_ATTACH : NOT_SUPPORTED;
export const DETACH = 'removeEventListener' in window ? SUPPORTS_REMOVE : 'detachEvent' in window ? SUPPORTS_DETACH : NOT_SUPPORTED;
export const QUERY = 'querySelector' in document.documentElement ? 'querySelectorAll' in document.documentElement ? SUPPORTS_QUERY_SELECTOR_ALL : SUPPORTS_QUERY_SELECTOR : NOT_SUPPORTED;
export const MATCH = 'contains' in document.documentElement ? 'matches' in document.documentElement ? SUPPORTS_CONTAINS_MATCHES : 'webkitMatchesSelector' in document.documentElement ? SUPPORTS_CONTAINS_MATCHES_WK : 'mozMatchesSelector' in document.documentElement ? SUPPORTS_CONTAINS_MATCHES_MZ : 'msMatchesSelector' in document.documentElement ? SUPPORTS_CONTAINS_MATCHES_MS : 'oMatchesSelector' in document.documentElement ? SUPPORTS_CONTAINS_MATCHES_OP : NOT_RECOGNISED : 'matches' in document.documentElement ? SUPPORTS_MATCHES : 'webkitMatchesSelector' in document.documentElement ? SUPPORTS_MATCHES_WK : 'mozMatchesSelector' in document.documentElement ? SUPPORTS_MATCHES_MZ : 'msMatchesSelector' in document.documentElement ? SUPPORTS_MATCHES_MS : 'oMatchesSelector' in document.documentElement ? SUPPORTS_MATCHES_OP : NOT_SUPPORTED;
