...
function attachDelegateWithPhase(type, element, {
  delegate,
  phase
}) {
  EVENT_MANAGER.attach(type, element, delegate, phase);
}
function detachDelegateWithPhase(type, element, {
  delegate,
  phase
}) {
...
export const attach = ATTACH === SUPPORTS_ADD ? attachDelegateWithPhase : ATTACH === SUPPORTS_ATTACH ? attachDelegate : notSupported;
export const detach = DETACH === SUPPORTS_REMOVE ? detachDelegateWithPhase : DETACH === SUPPORTS_DETACH ? detachDelegate : notSupported;
