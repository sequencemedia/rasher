import { SUPPORTS_ADD, SUPPORTS_REMOVE, SUPPORTS_ATTACH, SUPPORTS_DETACH, FACADE } from '#bom/rasher';
...
export const subscribe = FACADE === DELEGATE_WITH_PHASE ? delegateWithPhase : FACADE === DELEGATE ? delegate : notSupported;